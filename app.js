...
function hero(sub){return '<section class="hero"><img class="hero-image" src="/hero-genetic..png?v=8" alt="" aria-hidden="true"><div class="hero-panel"><div class="eyebrow">ביוטכנולוגיה · הנדסה גנטית</div><h1>דומינו בהנדסה גנטית</h1><p>'+esc(sub||'מקשיבים לרמז. מחכים לרגע הנכון. מחברים את השרשרת.')+'</p></div></section>';}
